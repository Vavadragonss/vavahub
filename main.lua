...
local Window = Rayfield:CreateWindow({
   ...
   KeySettings = {
      ...
      Key = {"nebulaexecutor2123","nebulaexecutor9210238123","pizza"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
   }
})
